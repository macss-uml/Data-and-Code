...
# NOTE: much of this code is from or based on my book forthcoming with Cambridge University Press; please do not share beyond this class. 
...
lle_fit1 <- lle(lle_scurve_data,
               m = 2,
               k = ok$k)

lle_scurve_data %>% 
  tibble() %>% 
  ggplot(aes(lle_fit1$Y[,1], lle_fit1$Y[,2], 
