...
g_rules <- apriori(groceries, 
                   parameter = list(support = 0.006, #Tune because the default would only leave the top items we found before. This is about twice a day - rewatch the video for this part !!!!
                                    confidence = 0.25, 
...
<!-- There's a lot of whole milk and yogurt - but these are top items. So maybe -->
